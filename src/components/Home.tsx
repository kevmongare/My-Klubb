...
function App() {
  ...
  return (
    ...
    <section  className='position-top sticky px-5 md:px-25 py-5 text-gray-800 postition-0 w-full shadow-sm left-0 top-0 mx-auto justify-between flex items-center bg-white md:bg-white/80 md:py-0 z-50'>
      <h1 className='flex items-center md:text-2xl text-sm font-extrabold text-orange-600'><img src={Logo} alt="" className='h-20 hidden md:flex' />My Klub</h1>
        ...
        className='hidden absolute top-16 left-0 w-full bg-orange-500  md:bg-transparent md:static md:flex md:space-x-6 md:items-center md:w-auto py-3 px-3'>
          <a href="" className='mr-5 block text-center text-1xl py-2 text-white md:text-gray-900 hover:md:text-orange-600'> Home </a>
          <a href="#About-t" className='mr-5 block text-1xl text-center  py-2 text-white md:text-gray-900 hover:md:text-orange-600'> About</a>
          <a href="" className='mr-5 text-1xl block text-center text-white  py-2 md:text-gray-900 hover:md:text-orange-600'>Projects</a>
          <a href="#contact" className='mr-5 block text-1xl text-center text-white  py-2 md:text-gray-900 hover:md:text-orange-600'>Contact</a>
      ...
      <div>
        <a href="" className=" rounded-full bg- bg-blue-950 border border-transparent bg-primary py-2 px-4 text-sm font-medium text-white hover:bg-primary-800 mr-2 hover:bg-orange-500 hidden md:inline-block">Register</a>
         ...
         <Link to="/login" className="text-white md:text-gray-900 ring-white ring-1 md:ring-orange-500 py-2 px-4 text-sm font-medium rounded-full hover:bg-orange-500 hover:ring-0 hover:text-white items-center">Log in <span aria-hidden="true">&rarr;</span></Link>
    ...
    <div className='justify-between grid md:flex pt-15 pb-5 h-3/4 max-w-7xl mx-auto items-center'>
      ...
      <div className='pl-8'>
              <h1 className='text-gray-800 text-7xl font-semibold tracking-tight text-balance '>POSTING  <br /> <span className='text-orange-600 font-stretch-130%'>PROJECTS</span><br />TO GET HIRED!</h1>
              <p className='text-gray-600 text-left text-2xl pt-10 w-3/4 grid'>Showcasing our work and connecting with companies seeking talent. 
    ...
    <div className="max-w-6xl mx-auto px-4 text-center">
      ...
      <div className='text-center'>
        <p className="text-1xl max-w-6xl mx-auto text-gray-600 pt-3 text-center rounded-lg">
         My Klub is a system I built to help me and my friends showcase our work and connect with companies seeking talent
         </p>
         <section className=' '>
    ...
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8 pb-5 bg-white rounded-sm p-10 mt-5 shadow-xl index-10" id='contact'>
            ...
            <div className="space-y-4 ">
                ...
                <a href="mailto:info@jurnevents.com" className="text-orange-500 hover:underline">kmongare4@gmail.com</a>
                </div>
                <div className="flex items-center space-x-4">
                ...
                <a href="tel:+254712345678" className="text-orange-500 hover:underline">+254 706384510</a>
                </div>
            </div>
            <div className="mt-6">
            <iframe className = "md:w-150 w-80 h=150 shadow-2xl rounded-2xl referrerpolicy="
            loading="lazy"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3916.065728259141!2d36.83092277487979!3d-1.3085513986790085!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f11f35c0cecdd%3A0x237a3a99ac017dfb!2sThe%20Ark%20Junior%20School-%20South%20B!5e1!3m2!1sen!2ske!4v1749671500085!5m2!1sen!2ske" >
            </iframe>
